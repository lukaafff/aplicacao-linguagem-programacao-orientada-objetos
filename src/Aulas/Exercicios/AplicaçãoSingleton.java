...
public class AplicaçãoSingleton {
    private static AplicaçãoSingleton instance; //SINGLETO NCampo privado para armazenar a única instância
    ...
    public static AplicaçãoSingleton getInstance() {
        if (instance == null) {
            instance = new AplicaçãoSingleton();
        }
        return instance;
    }
    ...
    public static void main(String[] args) {
        AplicaçãoSingleton.getInstance(); //SINGLETON Obtém a instância única
    }
}
